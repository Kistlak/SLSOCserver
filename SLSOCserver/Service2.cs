...
namespace SLSOCserver
{
    ...
    public class Service2 : IService2
    {
        ...
        public List<Feedbacksc> GetComFeedbacks()
        {
            List<Feedbacksc> studetails = new List<Feedbacksc>();
            try
            {
                cmd.CommandText = "SELECT id AS 'Explorer',modcode AS 'Module Code',feedback AS 'Feedback' FROM feedbacks WHERE fac='Computing'";
                cmd.CommandType = CommandType.Text;
