...
namespace SLSOCserver
{
    ...
    public class Service3 : IService3
    {
        ...
        public List<Feedbacksc> GetBusFeedbacks()
        {
            List<Feedbacksc> studetails = new List<Feedbacksc>();
            try
            {
                cmd.CommandText = "SELECT id AS 'Explorer',modcode AS 'Module Code',feedback AS 'Feedback' FROM feedbacks WHERE fac='Business'";
                cmd.CommandType = CommandType.Text;
